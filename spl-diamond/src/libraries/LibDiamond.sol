...
/// @title LibDiamond
/// @notice Core diamond storage and cut logic (ERC-2535 reference implementation)
library LibDiamond {
    ...
    struct DiamondStorage {
        // maps function selector => facet address and position of selector in selectors array
